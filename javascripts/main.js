function setCookie(e, t, n) {
    ...
    if (n) {
        var i = new Date;
        i.setTime(i.getTime() + 24 * n * 60 * 60 * 1e3), r = r + "; expires=" + i.toGMTString()
    }
...
function getCookie(e) {
    ...
    function T(e, t) {
        if (t in e) return t;
        for (var n = t.charAt(0).toUpperCase() + t.slice(1), r = t, i = Cn.length; i--;)
            if (t = Cn[i] + n, t in e) return t;
        return r
    }
    ...
    function S(e) {
        var t = G,
            n = Tn[e];
        return n || (n = j(e, t), "none" !== n && n || (cn = (cn || ut("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement), t = (cn[0].contentWindow || cn[0].contentDocument).document, t.write("<!doctype html><html><body>"), t.close(), n = j(e, t), cn.detach()), Tn[e] = n), n
    }
    ...
    var X, Q, U = typeof t,
        ...
        Tt = function(e) {
            (G.addEventListener || "load" === e.type || "complete" === G.readyState) && (wt(), ut.ready())
        },
        wt = function() {
    ...
    ut.fn = ut.prototype = {
        ...
        init: function(e, n, r) {
            ...
            if ("string" == typeof e) {
                ...
                if (i[1]) {
                    if (n = n instanceof ut ? n[0] : n, ut.merge(this, ut.parseHTML(i[1], n && n.nodeType ? n.ownerDocument || n : G, !0)), dt.test(i[1]) && ut.isPlainObject(n))
        ...
        noConflict: function(t) {
            return e.$ === ut && (e.$ = Y), t && e.jQuery === ut && (e.jQuery = V), ut
        },
        isReady: !1,
        readyWait: 1,
        ...
        ready: function(e) {
            if (e === !0 ? !--ut.readyWait : !ut.isReady) {
                ...
                ut.isReady = !0, e !== !0 && --ut.readyWait > 0 || (X.resolveWith(G, [ut]), ut.fn.trigger && ut(G).trigger("ready").off("ready"))
            }
        },
        ...
        if (!X)
            ...
            else if (G.addEventListener) G.addEventListener("DOMContentLoaded", Tt, !1), e.addEventListener("load", Tt, !1);
        else {
    ...
    ut.Callbacks = function(e) {
        ...
        o = G.createElement("select"), s = o.appendChild(G.createElement("option")), i = f.getElementsByTagName("input")[0], r.style.cssText = "top:1px;float:left;opacity:.5", t = {
        ...
        return f.style.backgroundClip = "content-box", f.cloneNode(!0).style.backgroundClip = "", t.clearCloneStyle = "content-box" === f.style.backgroundClip, ut(function() {
            ...
            a && (n = G.createElement("div"), n.style.cssText = "border:0;width:0;height:0;position:absolute;top:0;left:-9999px;margin-top:1px", a.appendChild(n).appendChild(f), f.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", i = f.getElementsByTagName("td"), i[0].style.cssText = "padding:0;margin:0;border:0;display:none", l = 0 === i[0].offsetHeight, i[0].style.display = "", i[1].style.display = "none", t.reliableHiddenOffsets = l && 0 === i[0].offsetHeight, f.innerHTML = "", f.style.cssText = "box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;padding:1px;border:1px;display:block;width:4px;margin-top:1%;position:absolute;top:1%;", t.boxSizing = 4 === f.offsetWidth, t.doesNotIncludeMarginInBodyOffset = 1 !== a.offsetTop, e.getComputedStyle && (t.pixelPosition = "1%" !== (e.getComputedStyle(f, null) || {}).top, t.boxSizingReliable = "4px" === (e.getComputedStyle(f, null) || {
                width: "4px"
            }).width, r = f.appendChild(G.createElement("div")), r.style.cssText = f.style.cssText = o, r.style.marginRight = r.style.width = "0", f.style.width = "1px", t.reliableMarginRight = !parseFloat((e.getComputedStyle(r, null) || {}).marginRight)), typeof f.style.zoom !== U && (f.innerHTML = "", f.style.cssText = o + "width:1px;padding:1px;display:inline;zoom:1", t.inlineBlockNeedsLayout = 3 === f.offsetWidth, f.style.display = "block", f.innerHTML = "<div></div>", f.firstChild.style.width = "5px", t.shrinkWrapBlocks = 3 !== f.offsetWidth, t.inlineBlockNeedsLayout && (a.style.zoom = 1)), a.removeChild(n), n = f = i = r = null)
        }), n = o = a = s = r = i = null, t
    }();
    var kt = /(?:\{[\s\S]*\}|\[[\s\S]*\])$/,
        Ct = /([A-Z])/g;
    ...
    ut.fn.extend({
        ...
        val: function(e) {
            ...
            })) : o ? (r = ut.valHooks[o.type] || ut.valHooks[o.nodeName.toLowerCase()], r && "get" in r && (n = r.get(o, "value")) !== t ? n : (n = o.value, "string" == typeof n ? n.replace(At, "") : null == n ? "" : n)) : void 0
        }
    }), ut.extend({
        valHooks: {
            option: {
        ...
        attr: function(e, n, r) {
            ...
            return e && 3 !== s && 8 !== s && 2 !== s ? typeof e.getAttribute === U ? ut.prop(e, n, r) : (o = 1 !== s || !ut.isXMLDoc(e), o && (n = n.toLowerCase(), i = ut.attrHooks[n] || (Ht.test(n) ? St : Et)), r === t ? i && o && "get" in i && null !== (a = i.get(e, n)) ? a : (typeof e.getAttribute !== U && (a = e.getAttribute(n)), null == a ? t : a) : null !== r ? i && o && "set" in i && (a = i.set(e, r, n)) !== t ? a : (e.setAttribute(n, r + ""), r) : (ut.removeAttr(e, n), t)) : void 0
        },
        removeAttr: function(e, t) {
            var n, r, i = 0,
                o = t && t.match(ct);
            if (o && 1 === e.nodeType)
                for (; n = o[i++];) r = ut.propFix[n] || n, Ht.test(n) ? !qt && Mt.test(n) ? e[ut.camelCase("default-" + n)] = e[r] = !1 : e[r] = !1 : ut.attr(e, n, ""), e.removeAttribute(qt ? n : r)
        },
        attrHooks: {
            type: {
                set: function(e, t) {
        ...
        get: function(e, n) {
            var r = ut.prop(e, n),
                ...
                o = "boolean" == typeof r ? Ot && qt ? null != i : Mt.test(n) ? e[ut.camelCase("default-" + n)] : !!i : e.getAttributeNode(n);
            return o && o.value !== !1 ? n.toLowerCase() : t
        },
        set: function(e, t, n) {
            return t === !1 ? ut.removeAttr(e, n) : Ot && qt || !Mt.test(n) ? e.setAttribute(!qt && ut.propFix[n] || n, n) : e[ut.camelCase("default-" + n)] = e[n] = !0, n
        }
    ...
    ut.event = {
            ...
            fix: function(e) {
                ...
                var t, n, r, i = e.type,
                    o = e,
                    a = this.fixHooks[i];
                for (a || (this.fixHooks[i] = a = Bt.test(i) ? this.mouseHooks : Ft.test(i) ? this.keyHooks : {}), r = a.props ? this.props.concat(a.props) : this.props, e = new ut.Event(o), t = r.length; t--;) n = r[t], e[n] = o[n];
        ...
        function(e, t) {
                ...
                if (!M && !r) {
                    if (i = gt.exec(e))
                        if (a = i[1]) {
                            ...
                            if ((a = i[3]) && W.getByClassName && t.getElementsByClassName) return Y.apply(n, K.call(t.getElementsByClassName(a), 0)), n
                        }
                    if (W.qsa && !q.test(e)) {
                        if (c = !0, d = R, h = t, g = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
            ...
            function m(e, t, n, r, o, a) {
                return r && !r[R] && (r = m(r)), o && !o[R] && (o = m(o, a)), i(function(i, a, s, u) {
                    var l, c, f, p = [],
                        d = [],
                        h = a.length,
                    ...
                    } else v = g(v === a ? v.splice(h, v.length) : v), o ? o(null, a, v, u) : Y.apply(a, v)
                })
            }
            ...
            function v(e, t) {
                var n = 0,
                    ...
                    s = function(i, s, u, l, c) {
                        ...
                        for (b && (A = s !== L && s, N = n); null != (f = T[y]); y++) {
                            if (o && f) {
                                for (p = 0; d = e[p++];)
                                    if (d(f, s, u)) {
                                        l.push(f);
                        ...
                        if (m += y, r && y !== m) {
                            ...
                            Y.apply(l, h), b && !i && h.length > 0 && m + t.length > 1 && a.uniqueSort(l)
                        }
                        return b && ($ = w, A = x), v
                    };
                return r ? i(s) : s
            ...
            function x(e, t, n, r) {
                ...
                if (!r && 1 === l.length) {
                    ...
                    for (i = pt.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !k.relative[s = a.type]);)
                        if ((u = k.find[s]) && (r = u(a.matches[0].replace(xt, Tt), dt.test(o[0].type) && t.parentNode || t))) {
            ...
            function T() {}
            var w, N, k, C, E, S, j, A, D, L, H, M, q, O, _, F, B, R = "sizzle" + -new Date,
                P = e.document,
                W = {},
                $ = 0,
                I = 0,
            ...
            E = a.isXML = function(e) {
                ...
                return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, H = r.documentElement, M = E(r), W.tagNameNoComments = o(function(e) {
                    ...
                    e.id = R + 0, e.innerHTML = "<a name='" + R + "'></a><div name='" + R + "'></div>", H.insertBefore(e, H.firstChild);
                    var t = r.getElementsByName && r.getElementsByName(R).length === 2 + r.getElementsByName(R + 0).length;
                    return W.getIdNotName = !r.getElementById(R), H.removeChild(e), t
                ...
                }, W.getIdNotName ? (k.find.ID = function(e, t) {
                ...
                }), k.find.TAG = W.tagNameNoComments ? function(e, n) {
                    ...
                    return o
                }, k.find.NAME = W.getByName && function(e, n) {
                    return typeof n.getElementsByName !== U ? n.getElementsByName(name) : t
                }, k.find.CLASS = W.getByClassName && function(e, n) {
                    return typeof n.getElementsByClassName === U || M ? t : n.getElementsByClassName(e)
                }, O = [], q = [":focus"], (W.qsa = n(r.querySelectorAll)) && (o(function(e) {
                ...
                })), (W.matchesSelector = n(_ = H.matchesSelector || H.mozMatchesSelector || H.webkitMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && o(function(e) {
                    W.disconnectedMatch = _.call(e, "div"), _.call(e, "[s!='']:x"), O.push("!=", ot)
                }), q = RegExp(q.join("|")), O = RegExp(O.join("|")), F = n(H.contains) || H.compareDocumentPosition ? function(e, t) {
                    ...
                    var n;
                    return e === t ? (j = !0, 0) : (n = t.compareDocumentPosition && e.compareDocumentPosition && e.compareDocumentPosition(t)) ? 1 & n || e.parentNode && 11 === e.parentNode.nodeType ? e === r || F(P, e) ? -1 : t === r || F(P, t) ? 1 : 0 : 4 & n ? -1 : 1 : e.compareDocumentPosition ? -1 : 1
                } : function(e, t) {
                    var n, i = 0,
                        o = e.parentNode,
                        a = t.parentNode,
                ...
                }, j = !1, [0, 0].sort(B), W.detectDuplicates = j, L) : L
            }, a.matches = function(e, t) {
                return a(e, null, null, t)
            }, a.matchesSelector = function(e, t) {
                if ((e.ownerDocument || e) !== L && D(e), t = t.replace(bt, "='$1']"), !(!W.matchesSelector || M || O && O.test(t) || q.test(t))) try {
                    var n = _.call(e, t);
                ...
                var n;
                return (e.ownerDocument || e) !== L && D(e), M || (t = t.toLowerCase()), (n = k.attrHandle[t]) ? n(e) : M || W.attributes ? e.getAttribute(t) : ((n = e.getAttributeNode(t)) || e.getAttribute(t)) && e[t] === !0 ? t : n && n.specified ? n.value : null
            }, a.error = function(e) {
                ...
                var t, n = [],
                    r = 1,
                    i = 0;
                if (j = !W.detectDuplicates, e.sort(B), j) {
                ...
                filter: {
                        ...
                        return 1 === r && 0 === i ? function(e) {
                            ...
                            if (m) {
                                ...
                                if (h = [a ? m.firstChild : m.lastChild], a && v) {
                                    for (c = m[R] || (m[R] = {}), l = c[e] || [], d = l[0] === $ && l[1], p = l[0] === $ && l[2], f = d && m.childNodes[d]; f = ++d && f && f[g] || (p = d = 0) || h.pop();)
                                        if (1 === f.nodeType && ++p && f === t) {
                                            c[e] = [$, d, p];
                                            break
                                        }
                                } else if (v && (l = (t[R] || (t[R] = {}))[e]) && l[0] === $) p = l[1];
                                else
                                    for (;
                                        (f = ++d && f && f[g] || (p = d = 0) || h.pop()) && ((s ? f.nodeName.toLowerCase() !== y : 1 !== f.nodeType) || !++p || (v && ((f[R] || (f[R] = {}))[e] = [$, p]), f !== t)););
                    ...
                    PSEUDO: function(e, t) {
                        ...
                        return r[R] ? r(t) : r.length > 1 ? (n = [e, e, "", t], k.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function(e, n) {
            ...
            S = a.compile = function(e, t) {
                ...
                return o
            }, k.pseudos.nth = k.pseudos.eq, k.filters = T.prototype = k.pseudos, k.setFilters = new T, D(), a.attr = ut.attr, ut.find = a, ut.expr = a.selectors, ut.expr[":"] = ut.expr.pseudos, ut.unique = a.uniqueSort, ut.text = a.getText, ut.isXMLDoc = a.isXML, ut.contains = a.contains
        }(e);
    var Wt = /Until$/,
    ...
    sn.optgroup = sn.option, sn.tbody = sn.tfoot = sn.colgroup = sn.caption = sn.thead, sn.th = sn.td, ut.fn.extend({
        ...
        html: function(e) {
            return ut.access(this, function(e) {
                ...
                if (!("string" != typeof e || en.test(e) || !ut.support.htmlSerialize && Gt.test(e) || !ut.support.leadingWhitespace && Jt.test(e) || sn[(Yt.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(Vt, "<$1></$2>");
                    try {
        ...
        clone: function(e, t, n) {
            ...
            if (ut.support.html5Clone || ut.isXMLDoc(e) || !Gt.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (ln.innerHTML = e.outerHTML, ln.removeChild(o = ln.firstChild)), !(ut.support.noCloneEvent && ut.support.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ut.isXMLDoc(e)))
        ...
        buildFragment: function(e, t, n, r) {
            for (var i, o, a, s, u, l, c, f = e.length, d = p(t), h = [], g = 0; f > g; g++)
                ...
                for (s = s || d.appendChild(t.createElement("div")), u = (Yt.exec(o) || ["", ""])[1].toLowerCase(), c = sn[u] || sn._default, s.innerHTML = c[1] + o.replace(Vt, "<$1></$2>") + c[2], i = c[0]; i--;) s = s.lastChild;
    ...
    ut.fn.extend({
        ...
        ut.cssHooks[n] = {
            ...
            set: function(e, t, r) {
                var i = r && fn(e);
                return k(e, t, r ? C(e, n, r, ut.support.boxSizing && "border-box" === ut.css(e, "boxSizing", !1, i), i) : 0)
            }
        }
    ...
    Ln = Wn.exec(Hn.toLowerCase()) || [], ut.fn.load = function(e, n, r) {
        ...
        ajax: function(e, n) {
            ...
            var i, o, a, s, u, l, c, f, p = ut.ajaxSetup({}, n),
                ...
                w = {
                    ...
                    getResponseHeader: function(e) {
                        ...
                        if (2 === x) {
                            if (!f)
                                for (f = {}; t = Fn.exec(s);) f[t[1].toLowerCase()] = t[2];
                            t = f[e.toLowerCase()]
                        }
            ...
            if (g.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, p.url = ((e || p.url || Hn) + "").replace(On, "").replace(Pn, Ln[1] + "//"), p.type = n.method || n.type || p.method || p.type, p.dataTypes = ut.trim(p.dataType || "*").toLowerCase().match(ct) || [""], null == p.crossDomain && (i = Wn.exec(p.url.toLowerCase()), p.crossDomain = !(!i || i[1] === Ln[1] && i[2] === Ln[2] && (i[3] || ("http:" === i[1] ? 80 : 443)) == (Ln[3] || ("http:" === Ln[1] ? 80 : 443)))), p.data && p.processData && "string" != typeof p.data && (p.data = ut.param(p.data, p.traditional)), L(In, p, n, w), 2 === x) return w;
            l = p.global, l && 0 === ut.active++ && ut.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Rn.test(p.type), a = p.url, p.hasContent || (p.data && (a = p.url += (qn.test(a) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = _n.test(a) ? a.replace(_n, "$1_=" + Mn++) : a + (qn.test(a) ? "&" : "?") + "_=" + Mn++)), p.ifModified && (ut.lastModified[a] && w.setRequestHeader("If-Modified-Since", ut.lastModified[a]), ut.etag[a] && w.setRequestHeader("If-None-Match", ut.etag[a])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && w.setRequestHeader("Content-Type", p.contentType), w.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Xn + "; q=0.01" : "") : p.accepts["*"]);
    ...
    ut.ajaxSetup({
        ...
        return u || "jsonp" === n.dataTypes[0] ? (o = n.jsonpCallback = ut.isFunction(n.jsonpCallback) ? n.jsonpCallback() : n.jsonpCallback, u ? n[u] = n[u].replace(Gn, "$1" + o) : n.jsonp !== !1 && (n.url += (qn.test(n.url) ? "&" : "?") + n.jsonp + "=" + o), n.converters["script json"] = function() {
            return s || ut.error(o + " was not called"), s[0]
        }, n.dataTypes[0] = "json", a = e[o], e[o] = function() {
            s = arguments
        }, i.always(function() {
            e[o] = a, n[o] && (n.jsonpCallback = r.jsonpCallback, Un.push(o)), s && ut.isFunction(a) && a(s[0]), s = a = t
        }), "script") : t
    });
    var Jn, Vn, Yn = 0,
    ...
    ut.ajaxSettings.xhr = e.ActiveXObject ? function() {
        return !this.isLocal && O() || _()
    } : O, Vn = ut.ajaxSettings.xhr(), ut.support.cors = !!Vn && "withCredentials" in Vn, Vn = ut.support.ajax = !!Vn, Vn && ut.ajaxTransport(function(n) {
            ...
            return {
                send: function(i, o) {
                    ...
                    u.send(n.hasContent && n.data || null), r = function(e, i) {
                        ...
                        f && o(s, c, f, l)
                    }, n.async ? 4 === u.readyState ? setTimeout(r) : (a = ++Yn, Kn && (Jn || (Jn = {}, ut(e).unload(Kn)), Jn[a] = r), u.onreadystatechange = r) : r()
                },
                abort: function() {
                    r && r(t, !0)
                }
...
}(window), require(["jquery"], function(e) {
    void 0 === e.migrateMute && (e.migrateMute = !0),
        function(e, t, n) {
            function r(n) {
                var r = t.console;
            ...
            i(e, "attrFn", a || {}, "jQuery.attrFn is deprecated"), e.attr = function(t, i, o, u) {
                var l = i.toLowerCase(),
                    h = t && t.nodeType;
                return u && (4 > s.length && r("jQuery.fn.attr( props, pass ) is deprecated"), t && !f.test(h) && (a ? i in a : e.isFunction(e.fn[i]))) ? e(t)[i](o) : ("type" === i && o !== n && c.test(t.nodeName) && t.parentNode && r("Can't change the 'type' of an input or button in IE 6/7/8"), !e.attrHooks[l] && p.test(l) && (e.attrHooks[l] = {
                    get: function(t, r) {
                        var i, o = e.prop(t, r);
                ...
                }, d.test(l) && r("jQuery.fn.attr('" + l + "') may use property instead of attribute")), s.call(e, t, i, o))
            }, e.attrHooks.value = {
                get: function(e, t) {
            ...
            e.fn.init = function(t, n, i) {
                var o;
                return t && "string" == typeof t && !e.isPlainObject(n) && (o = v.exec(e.trim(t))) && o[0] && ("<" !== t.charAt(0) && r("$(html) HTML strings must start with '<' character"), o[3] && r("$(html) HTML text after last tag is ignored"), "#" === o[0].charAt(0) && (r("HTML string cannot start with a '#' character"), e.error("JQMIGRATE: Invalid selector string (XSS)")), n && n.context && (n = n.context), e.parseHTML) ? m.call(this, e.parseHTML(o[2], n, !0), n, i) : m.apply(this, arguments)
            }, e.fn.init.prototype = e.fn, e.parseJSON = function(e) {
                return e || null === e ? y.apply(this, arguments) : (r("jQuery.parseJSON requires a valid JSON string"), null)
            ...
            e.fn.andSelf = function() {
                return r("jQuery.fn.andSelf() replaced by jQuery.fn.addBack()"), T.apply(this, arguments)
            ...
            e.event.props && "attrChange" !== e.event.props[0] && e.event.props.unshift("attrChange", "attrName", "relatedNode", "srcElement"), e.event.dispatch && i(e.event, "handle", e.event.dispatch, "jQuery.event.handle is undocumented and deprecated"), e.event.add = function(e, t, n, i, o) {
                e !== document && A.test(t) && r("AJAX events should be attached to document: " + t), w.call(this, e, L(t || ""), n, i, o)
            }, e.event.remove = function(e, t, n, r, i) {
                N.call(this, e, L(t) || "", n, r, i)
            }, e.fn.error = function() {
                ...
                return n || A.test(e) || r("Global events are undocumented and deprecated"), k.call(this, e, t, n || document, i)
...
require(["jquery"], function(e) {
    e(document).ready(function() {
        e(function() {
            function t() {
                var e = o ? "related-" + o : "related";
                i && (e += "-with-cookie"), r.length && "related" !== e && r.addClass(e)
            }
            var n = e("#global-cookie-message"),
                r = e("#wrapper .related-positioning"),
                i = n.length && null === getCookie("seen_cookie_message"),
                o = e(".beta-notice").length ? "beta" : null;
            i && (r.length && "undefined" != typeof GOVUK.stopScrollingAtFooter && GOVUK.stopScrollingAtFooter.updateFooterTop(), n.show(), setCookie("seen_cookie_message", "yes", 28)), t()
        })
    })
}), define("header-footer-only", function() {}), require(["jquery"], function(e) {
    var t = e("div.radio"),
        n = t.find(".form-radio.selectable"),
        r = n.children("input:radio");
    r.each(function() {
        e(this).on("change", function() {
            e("input:radio:checked").length > 0 ? (e("input:radio").parent("label").removeClass("selected"), e(this).parent("label").addClass("selected")) : !e("input:radio:checked").length > 0 && e(this).parent("label").removeClass("selected")
        })
    })
}), define("radio-input", function() {}), require.config({
    paths: {
    ...
    optimize: "none"
}), require(["jquery", "jquery-migrate", "header-footer-only", "radio-input"], function(e) {
    var t = navigator.userAgent.match(/(MSIE 10.0)/g) ? !0 : !1;
    t && e("html").addClass("ie10"), e(function() {
        e("[autofocus]:not(:focus)").eq(0).focus(), e(".button-not-implemented").click(function() {
            return !1
        }), e(".print-button").click(function() {
            return window.print(), !1
        }), e('a[href^="#"]').bind("click.smoothscroll", function(t) {
            t.preventDefault(); {
                var n = this.hash;
                e(n)
            }
            e("html, body").animate({
                scrollTop: e(n).offset().top - 40
            }, 750, "swing", function() {
