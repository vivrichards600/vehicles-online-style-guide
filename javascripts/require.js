...
! function(global) {
    ...
    function newContext(e) {
        ...
        function i(e, i, r) {
            var n, a, o, s, c, u, p, d, f, l, h, m, g = i && i.split("/"),
                v = y.map,
                x = v && v["*"];
            if (e && (e = e.split("/"), p = e.length - 1, y.nodeIdCompat && jsSuffixRegExp.test(e[p]) && (e[p] = e[p].replace(jsSuffixRegExp, "")), "." === e[0].charAt(0) && g && (m = g.slice(0, g.length - 1), e = m.concat(e)), t(e), e = e.join("/")), r && v && (g || x)) {
                o = e.split("/");
        ...
        function o(e, t, r, n) {
            ...
            return e || (l = !1, e = "_@r" + (A += 1)), u = a(e), p = u[0], e = u[1], p && (p = i(p, d, n), s = getOwn(j, p)), e && (p ? h = s && s.normalize ? s.normalize(e, function(e) {
                return i(e, d, n)
            }) : -1 === e.indexOf("!") ? i(e, d, n) : e : (h = i(e, d, n), u = a(h), p = u[0], h = u[1], r = !0, o = q.nameToUrl(h))), c = !p || s || r ? "" : "_unnormalized" + (T += 1), {
                prefix: p,
                name: h,
                parentMap: t,
                unnormalized: !!c,
            ...
            if (!x) {
                if (x = !0, eachProp(k, function(e) {
                    ...
                    if (e.enabled && (i.isDefine || s.push(e), !e.error))
                        ...
                        else if (!e.inited && e.fetched && i.isDefine && (c = !0, !i.prefix)) return p = !1
        ...
        return E = {
            ...
            callPlugin: function() {
                ...
                this.depMaps.push(r), c(r, "defined", bind(this, function(r) {
                    var n, a, p, f = getOwn(R, this.map.id),
                        l = this.map.name,
            ...
            makeRequire: function(t, n) {
                ...
                return n = n || {}, mixin(a, {
                    ...
                    var i = o(e, t, !0),
                        n = getOwn(S, e);
                    r(e), delete j[e], delete P[i.url], delete O[e], eachReverse(M, function(t, i) {
                        t[0] === e && M.splice(i, 1)
            ...
            nameToUrl: function(e, t, i) {
                ...
                if (p && (e = p), u = getOwn(R, e)) return q.nameToUrl(u, t, i);
